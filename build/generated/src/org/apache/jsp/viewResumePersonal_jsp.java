...
public final class viewResumePersonal_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Security.checkHijackedSession(session, request)) {
      ...
      out.write("        <script src=\"js/rivets.bundles.min.js\"></script>\r\n");
      out.write("    </head>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("    <body>\r\n");
...
out.print(resumeID);
      ...
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    function setMinor(minor){\r\n");
      out.write("         var minor;\r\n");
      out.write("         if (minor != \"\"){\r\n");
      out.write("                \r\n");
      out.write("            }\r\n");
      ...
      out.write("        $emailPhoneInfo.append('<h4> <strong>Phone: </strong>' + data.phoneNumber + '&nbsp &nbsp<strong>   Email: </strong>' + data.email + '</h4>');\r\n");
      out.write("\r\n");
      out.write("    }\r\n");
      out.write("    ;\r\n");
      out.write("\r\n");
      ...
      out.write("            $contactInfo.append('<h4>' + data['addresses'][i].addressLine1 + ' ' + data['addresses'][i].addressLine2 + ', '\r\n");
      out.write("                                + data['addresses'][i].city + ', ' + data['addresses'][i].state + ' ' + data['addresses'][i].postalCode + '</h4>');\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("            \r\n");
      out.write("            var minor = (data['EducationList'][i].minor || \"\");\r\n");
      out.write("        \r\n");
      out.write("            $education.append('<div style=\"padding: 0 0 30px 0;\">');\r\n");
      out.write("            $education.append('<div style=\"float:right; display:inline\"><h4>' + data['EducationList'][i].graduationDate + '</h4></div>');\r\n");
      out.write("            $education.append('<h3>' + data['EducationList'][i].name + '</h3>');\r\n");
      out.write("            $education.append('<h4>' + data['EducationList'][i].type + ', ' + data['EducationList'][i].field);\r\n");
      out.write("           \r\n");
      out.write("            $education.append('<h4> GPA: ' + gpa + '</h4>');\r\n");
      ...
      out.write("            $endDate = data['WorkExperienceList'][i].endDate;\r\n");
      out.write("            \r\n");
      out.write("//            Changes end date to present if currently employed\r\n");
      out.write("//                if (data.currentlyEmployed == 1){\r\n");
      out.write("//                    $endDate = \"Present\";\r\n");
      out.write("//                }\r\n");
      out.write("            \r\n");
      out.write("            $workExperience.append('<div style=\"padding: 0 0 20px 0;\">');\r\n");
      out.write("            $workExperience.append('<div style=\"float:right; display:inline\"><h4>' + data['WorkExperienceList'][i].startDate + ' - ' + $endDate + '</h4></div>');\r\n");
      out.write("            $workExperience.append('<h3>' + data['WorkExperienceList'][i].businessName + '</h3>');\r\n");
      out.write("            $workExperience.append('<div><div style\"float:left; display:inline\"><h4>' + data['WorkExperienceList'][i].position + '</h4></div>');\r\n");
      out.write("            $workExperience.append('<div style:\"display:block\"><p>' + data['WorkExperienceList'][i].description + '</p></div>');\r\n");
      ...
      out.write("        <div class=\"title span9\" id=\"userName\">\r\n");
      out.write("            <!--            <h1>John Smith</h1>-->\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"title span9\" id=\"contactInfo\">\r\n");
      out.write("            <!--Address Information Appears Here-->\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div class=\"title span9\" id=\"emailPhoneInfo\">\r\n");
