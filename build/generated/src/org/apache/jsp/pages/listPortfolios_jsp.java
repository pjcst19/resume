...
public final class listPortfolios_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 out.print(user.getUserID());
      ...
      out.write("        <div class=\"panel-heading\"><strong>View Portfolios</strong></div>\r\n");
      ...
      out.write("                <th>View Portfolio</th>\r\n");
      out.write("                <th>Edit Portfolio</th>\r\n");
      out.write("            </tr>\r\n");
      out.write("        </table>\r\n");
      out.write("    </div>\r\n");
      out.write("    <script>\r\n");
 ...
 out.print(request.getParameter("userID"));
      ...
      out.write("                for (var j = 0; j < data[i]['portfolios'].length; j++) {\r\n");
      out.write("                    var $row = $('<tr />');\r\n");
      out.write("                    $row.append('<td>' + data[i].lastName + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i].firstName + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i]['portfolios'][j].created + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i]['portfolios'][j].modified + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i]['portfolios'][j].portfolioID + '</td>');\r\n");
      out.write("                    $row.append('<td><a href=\"viewPortfolioPersonal.jsp?portfolioID=' + data[i]['portfolios'][j].portfolioID + '\">View</a></td>');\r\n");
      out.write("                    $row.append('<td><a href=\"viewEditPortfolio.jsp?portfolioID=' + data[i]['portfolios'][j].portfolioID + '\">Edit</a></td>');\r\n");
