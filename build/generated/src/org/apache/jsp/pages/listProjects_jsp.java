...
public final class listProjects_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 out.print(user.getUserID());
      ...
      out.write("        <div class=\"panel-heading\"><strong>View All Projects</strong></div>\r\n");
      ...
      out.write("                <th>View Project</th>\r\n");
      out.write("                <th>Edit Project</th>\r\n");
      out.write("            </tr>\r\n");
      out.write("        </table>\r\n");
      out.write("    </div>\r\n");
      out.write("    <script>\r\n");
 ...
 out.print(request.getParameter("userID"));
      ...
      out.write("                for (var j = 0; j < data[i]['projects'].length; j++) {\r\n");
      out.write("                    var $row = $('<tr />');\r\n");
      out.write("                    $row.append('<td>' + data[i].PortfolioID + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i]['projects'][j].projectID + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i].ProjectName + '</td>');                    \r\n");
      out.write("                    $row.append('<td>' + data[i]['projects'][j].created + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i]['projects'][j].modified + '</td>');                    \r\n");
      out.write("                    $row.append('<td><a href=\"viewProjectPersonal.jsp?projectID=' + data[i]['projects'][j].projectID + '\">View</a></td>');\r\n");
      out.write("                    $row.append('<td><a href=\"viewEditProject.jsp?projectID=' + data[i]['projects'][j].projectID + '\">Edit</a></td>');\r\n");
