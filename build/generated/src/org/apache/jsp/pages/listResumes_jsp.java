...
public final class listResumes_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 out.print(user.getUserID());
      ...
      out.write("        <div class=\"panel-heading\"><strong>View All Resumes</strong></div>\r\n");
      ...
      out.write("                <th>Resume ID</th>\r\n");
      out.write("                <th>View Resume</th>\r\n");
      out.write("                <th>Edit Resume</th>\r\n");
      out.write("            </tr>\r\n");
      out.write("        </table>\r\n");
      out.write("    </div>\r\n");
      out.write("    <script>\r\n");
 ...
 out.print(request.getParameter("userID"));
      ...
      out.write("                for (var j = 0; j < data[i]['resumes'].length; j++) {\r\n");
      out.write("                    var $row = $('<tr />');\r\n");
      out.write("                    $row.append('<td>' + data[i].lastName + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i].firstName + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i]['resumes'][j].created + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i]['resumes'][j].modified + '</td>');\r\n");
      out.write("                    $row.append('<td>' + data[i]['resumes'][j].resumeID + '</td>');\r\n");
      out.write("                    $row.append('<td><a href=\"viewResumePersonal.jsp?resumeID=' + data[i]['resumes'][j].resumeID + '\">View</a></td>');\r\n");
      out.write("                    $row.append('<td><a href=\"viewEditResume.jsp?resumeID=' + data[i]['resumes'][j].resumeID + '\">Edit</a></td>');\r\n");
