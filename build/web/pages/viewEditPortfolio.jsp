<%-- 
    Document   : viewEditPortfolio
    Created on : Feb 16th, 4:46:44 PM
...
<div id="mainContainer" class="container theme-showcase" style="width:900px">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><strong>Edit Your Portfolio</strong></h3>
        </div>
        <div class="panel-body">
            <div id="page-header">
                <h2 class="form-signin-heading resumeHeader">Projects</h2><br>
            ...
            <div data-bind="foreach: portfolios">
                <div id="editEduList">
