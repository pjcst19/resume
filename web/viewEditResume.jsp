            ...
            <div data-bind="foreach: resumes">
                ...
                <div id="editEduList">
                    <div data-bind="foreach: EducationList">
                        ...
                        <!--                         <div style="float:left; margin-right:20px; display">
                                                <label> Major </label><input data-bind="value: field" type="text" class="form-control" id="txtMajorType" name="txtMajorType" placeholder="Major" required display:inline">
