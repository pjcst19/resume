    ...
    (function (p) {
        ...
        (function (p) {
            ...
            a.a = function () {
                ...
                return{vb: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], u: function (a, b) {
            ...
            var G = "change", A = {U: function (b, d, c) {
                    var e = this;
                    c = c || G;
            ...
            a.Y = a.k = function () {
                ...
                var c = [], e, g = 0;
                return{Ea: b, end: d, Jb: function (b) {
                        if (e) {
                            if (!a.Db(b))
                            ...
                            switch (d) {
                                ...
                                case "splice":
                                    ...
                                    for (var h = 1 === t ? h : Math.min(d + (m[1] || 0),
                                            h), t = d + t - 2, z = Math.max(h, t), u = [], r = [], E = 2; d < z; ++d, ++E)
            ...
            (function () {
                ...
                var g = v && "\x3c!--test--\x3e" === v.createComment("test").text, h = g ? /^\x3c!--\s*ko(?:\s+([\s\S]+))?\s*--\x3e$/ : /^\s*ko(?:\s+([\s\S]+))?\s*$/,
                        k = g ? /^\x3c!--\s*\/ko\s*--\x3e$/ : /^\s*\/ko\s*$/, f = {ul: !0, ol: !0};
                a.f = {Q: {}, childNodes: function (a) {
            ...
            (function () {
                function b(b, e) {
                    ...
                    if (g) {
                        var g = d.parseBindingsString(g, e, b, {valueAccessors: !0, bindingParams: !0}), g = a.a.na(g, function (d) {
            ...
            (function () {
                ...
                a.h.V.checked = !0;
                a.d.checkedValue = {update: function (b, d) {
                        b.value = a.a.c(d())
                    }}
            })();
            ...
            a.d.foreach = {Eb: function (b) {
                    return function () {
                        var d = b(), c = a.a.Xa(d);
                        if (!c || "number" == typeof c.length)
                            return{foreach: d, templateEngine: a.O.Oa};
                        a.a.c(d);
                        return{foreach: c.data, as: c.as, includeDestroyed: c.includeDestroyed, afterAdd: c.afterAdd, beforeRemove: c.beforeRemove, afterRender: c.afterRender, beforeMove: c.beforeMove, afterMove: c.afterMove, templateEngine: a.O.Oa}
                    }
                }, init: function (b,
                        d) {
            ...
            a.d.selectedOptions = {after: ["options", "foreach"], init: function (b, d, c) {
            ...
            a.d.submit = {init: function (b, d, c, e, g) {
            ...
            (function () {
                if (s && s.navigator)
                    ...
                    }, d = s.opera && s.opera.version && parseInt(s.opera.version()), c = s.navigator.userAgent, e = b(c.match(/^(?:(?!chrome).)*version\/([^ ]*) safari/i)), g = b(c.match(/Firefox\/([^ ]*)/));
                if (10 > a.a.L)
                    var h = a.a.e.F(), k = a.a.e.F(), f = function (b) {
