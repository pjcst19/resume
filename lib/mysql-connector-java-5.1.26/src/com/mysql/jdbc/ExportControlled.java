...
public class ExportControlled {
     ...
     *
     * @param mysqlIO the MysqlIO instance containing the socket to convert to
     * an SSLSocket.
     *
     * @throws CommunicationsException if the handshake fails, or if this
     * distribution of Connector/J doesn't contain the SSL crytpo hooks needed
