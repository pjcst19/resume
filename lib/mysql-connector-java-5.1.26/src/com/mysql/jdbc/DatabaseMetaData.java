...
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
     ...
     * @param positionOfReturnKeyword the position of "RETRUNS" in the
     * definition
                        ...
                        try {
                            ...
                            while (results.next()) {
                                ...
                                if (typeDesc.columnSize == null) {
                                    ...
                                    int mbminlen = 1;
                                    if (collation != null && ("TEXT".equals(typeDesc.typeName)
     ...
     * <li> <b>COLUMN_DEF</b> String => default value for the column (may be
     * null) </li>
     ...
     * character based columns. For any other datatype the returned value is a
     * NULL </li>
     * <li> <b>ORDINAL_POSITION</b> int => the ordinal position, starting from
     * 1. A value of 0 is returned if this row describes the procedure's return
     * value. </li>
     ...
     * </ul>
     * </li>
     * <li> SPECIFIC_NAME String => the name which uniquely identifies this
     * procedure within its schema. </li>
     * </ol>
     * </p>
     * <P>
...
//							SQLError.SQL_STATE_GENERAL_ERROR, getExceptionInterceptor());		
     ...
     * <li> <B>DATA_TYPE</B> String => type value defined in java.sql.Types. One
     * of JAVA_OBJECT, STRUCT, or DISTINCT </li>
     * <li> <B>REMARKS</B> String => explanatory comment on the type </li>
     * </ol>
     * </p>
     * <P>
     * <B>Note:</B> If the driver does not support UDTs then an empty result set
     * is returned.
     * </p>
     *
