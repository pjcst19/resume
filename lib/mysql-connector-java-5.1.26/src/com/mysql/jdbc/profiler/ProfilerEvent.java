...
public class ProfilerEvent {
     ...
     * @param eventDurationMillis how long did the event last?
     ...
     * @throws Exception if an error occurs while unpacking the event
     */
     ...
     * @throws Exception if an error occurs while packing this event.
     */
