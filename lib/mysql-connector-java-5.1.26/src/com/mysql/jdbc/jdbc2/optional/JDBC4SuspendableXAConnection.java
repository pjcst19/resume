...
public class JDBC4SuspendableXAConnection extends SuspendableXAConnection {
     ...
     * <code>PooledConnection</code> object. Components that wish to be notified
     * when  <code>PreparedStatement</code>s created by the connection are closed
     * or are detected to be invalid may use this method to register a
     * <code>StatementEventListener</code> with this
     ...
     * of components that will be notified when the driver detects that a
