...
public class DatabaseMetaDataUsingInfoSchema extends DatabaseMetaData {
     ...
     * to others; "NO" if not; null if unknown </li>
     * </ol>
     * </p>
     *
    ...
    /**
     * Returns a condition to be injected in the query that returns metadata for
     * procedures only. Overridden by subclasses when needed. When not empty
     * must end with "AND ".
     *
    ...
    /**
     * Redirects to another implementation of #getProcedureColumns. Subclasses
    ...
    /**
     * Returns a condition to be injected in the query that returns metadata for
     * procedure columns only. Overridden by subclasses when needed. When not
     * empty must end with "AND ".
     *
     * @return String with the condition to be injected.
     */
     ...
     * <code>null</code>)
     * <LI><B>FUNCTION_NAME</B> String => function name. This is the name used
     ...
     * <LI> functionColumnResult - Indicates that the parameter or column is a
     * column in the <code>ResultSet</code>
     * </UL>
     * <LI><B>DATA_TYPE</B> int => SQL type from java.sql.Types
     * <LI><B>TYPE_NAME</B> String => SQL type name, for a UDT type the type
     * name is fully qualified
     ...
     * character based parameters or columns. For any other datatype the
     * returned value is a NULL
     * <LI><B>ORDINAL_POSITION</B> int => the ordinal position, starting from 1,
     * for the input and output parameters. A value of 0 is returned if this row
    ...
    /**
     * Getter to JDBC4 DatabaseMetaData.function* constants. This method must be
     * overridden by JDBC4 subclasses. this implementation should never be
     * called.
     *
     ...
     * <UL>
     * <LI>functionResultUnknown - Cannot determine if a return value or table
     * will be returned
    ...
    /**
     * Getter to JDBC4 DatabaseMetaData.functionNoTable constant. This method
     * must be overridden by JDBC4 subclasses. this implementation should never
     * be called.
     *
     * @return 0
     */
