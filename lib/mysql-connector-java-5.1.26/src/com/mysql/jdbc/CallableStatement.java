...
public class CallableStatement extends PreparedStatement implements
    ...
    protected class CallableStatementParamInfoJDBC3 extends CallableStatementParamInfo
         ...
         * false otherwise. If this implements the interface then return true,
         * else if this is a wrapper then return the result of recursively
         * calling <code>isWrapperFor</code> on the wrapped object. If this does
         * not implement the interface and is not a wrapper, return false. This
         * method should be implemented as a low-cost operation compared to
         ...
         * to non-standard methods, or standard methods not exposed by the
         * proxy. The result may be either the object found to implement the
         * interface or a proxy for that object. If the receiver implements the
         * interface then that is the object. If the receiver is a wrapper and
         * the wrapped object implements the interface then that is the object.
         * Otherwise the object is the result of calling <code>unwrap</code>
         * recursively on the wrapped object. If the receiver is not a wrapper
         * and does not implement the interface, then an
    ...
    /**
     * Creates a callable statement instance -- We need to provide factory-style
