...
public interface BalanceStrategy extends Extension {
     ...
     * the JDBC connection, and serves as a factory for new connections for this
     * strategy via the createConnectionForHost() method.
     *
     ...
     * @param configuredHosts the list of hosts/ports (in "host:port" form) as
     * passed in by the user.
     * @param liveConnections a map of host/ports to "live" connections to them.
     * @param responseTimes the list of response times for a
     * <strong>transaction</strong>
     * for each host in the configured hosts list.
     * @param numRetries the number of times the driver expects this strategy to
     * re-try connection attempts if creating a new connection fails.
     * @return the physical JDBC connection for the application to use, based
     * upon the strategy employed.
     * @throws SQLException if a new connection can not be found or created by
     * this strategy.
     *
