...
public class NonRegisteringDriver implements java.sql.Driver {
    ...
    /**
     * Expands hosts of the form
     * address=(protocol=tcp)(host=localhost)(port=3306) into a
     * java.util.Properties. Special characters (in this case () and =) must be
     * quoted. Any values that are string-quoted ("" or '') are also stripped of
     * quotes.
     */
