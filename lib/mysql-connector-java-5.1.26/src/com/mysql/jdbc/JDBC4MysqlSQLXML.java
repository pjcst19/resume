...
public class JDBC4MysqlSQLXML implements SQLXML {
     ...
     * @throws SQLException if there is an error processing the XML value. The
     * getCause() method of the exception may provide a more detailed exception,
     * for example, if the stream does not contain valid characters. An
     * exception is thrown if the state is not writable.
     ...
     * getCause() method of the exception may provide a more detailed exception,
     * for example, if the stream does not contain valid characters. An
     * exception is thrown if the state is not readable.
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     * support this method
     * @since 1.6
     */
     ...
     * </pre>
     *
     * @param sourceClass The class of the source, or null. If the class is
     * null, a vendor specifc Source implementation will be returned. The
     ...
     * @throws SQLException if there is an error processing the XML value or if
     * this feature is not supported. The getCause() method of the exception may
     * provide a more detailed exception, for example, if an XML parser
     * exception occurs. An exception is thrown if the state is not readable.
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     * support this method
     * @since 1.6
     */
     ...
     * @throws SQLException if there is an error processing the XML value. An
     * exception is thrown if the state is not writable.
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     * support this method
     * @since 1.6
     ...
     * </pre>
     *
     * @param resultClass The class of the result, or null. If resultClass is
     * null, a vendor specific Result implementation will be returned. The
     * following classes are supported at a minimum:
     *
     * <pre>
     ...
     * this feature is not supported. The getCause() method of the exception may
     * provide a more detailed exception, for example, if an XML parser
     * exception occurs. An exception is thrown if the state is not writable.
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     * support this method
     * @since 1.6
     */
