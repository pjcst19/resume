...
public class JDBC4DatabaseMetaDataUsingInfoSchema extends DatabaseMetaDataUsingInfoSchema {
     ...
     * procedures only. Overrides
     * DatabaseMetaDataUsingInfoSchema#injectRoutineTypeConditionForGetProcedures.
     * When not empty must end with "AND ".
     *
    ...
    /**
     * Returns a condition to be injected in the query that returns metadata for
     * procedure columns only. Overrides
     * DatabaseMetaDataUsingInfoSchema#injectRoutineTypeConditionForGetProcedureColumns.
     * When not empty must end with "AND ".
     *
     * @return String with the condition to be injected.
     */
    ...
    /**
     * Overrides
     * DatabaseMetaDataUsingInfoSchema#getJDBC4FunctionNoTableConstant.
     *
    ...
    /**
     * Overrides DatabaseMetaData#getColumnType(boolean, boolean, boolean,
     * boolean).
     *
     * @see JDBC4DatabaseMetaData#getProcedureOrFunctionColumnType(boolean,
