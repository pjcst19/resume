...
public abstract class ResultSetRow {
    ...
    /**
     * Returns data at the given index as an InputStream with no character
     * conversion.
     *
     * @param columnIndex of the column value (starting at 0) to return.
     * @return the value at the given index as an InputStream or null if null.
     *
     ...
     * interface should use isNull() beforehand to determine status of NULL
     ...
     *
     * @throws SQLException if an error occurs, or the concrete RowHolder
