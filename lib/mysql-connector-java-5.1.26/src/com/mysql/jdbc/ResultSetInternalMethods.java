...
public interface ResultSetInternalMethods extends java.sql.ResultSet {
    ...
    /**
     * Returns a new instance of this result set, that shares the underlying row
     * data.
     */
     ...
     * returned by "SHOW ..." or SELECTs on INFORMATION_SCHEMA performed on
     * behalf of methods in DatabaseMetadata.
     */
