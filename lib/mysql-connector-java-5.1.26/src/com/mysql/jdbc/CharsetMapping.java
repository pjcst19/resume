...
public class CharsetMapping {
    ...
    /**
     * Size of static maps INDEX_TO_JAVA_CHARSET, INDEX_TO_MYSQL_CHARSET,
     * INDEX_TO_COLLATION
     */
    ...
    static {
        ...
        for (int i = 1; i < MAP_SIZE; i++) {
            ...
            if (INDEX_TO_CHARSET[i] != null) {
                indexMap.put(INDEX_TO_CHARSET[i], i);
            }
        }
        ...
        for (int i = 1; i < MAP_SIZE; i++) {
            ...
            if (indexToMysqlCharset.get(i) == null) {
     ...
     * has gone through initialization phase and determined server
     * configuration, as not enough information is available to make an
     * intelligent decision until then.
     *
