 ...
 * the JDBC API for MySQL's implementation of java.sql.Statement.
 *
 ...
 * why there are still references to StatementImpl throughout the code).
 *
 * @version $Id: $
 *
 */
public interface Statement extends java.sql.Statement {
     ...
     * Statement.setFetchSize() so that applications can use the Java variant of
     * libmysql's mysql_use_result() behavior.
     *
     * @throws SQLException
     */
    ...
    /**
     * Callback for result set instances to remove them from the Set that tracks
     * them per-statement
     */
