...
public class StatementImpl implements Statement {
    ...
    /**
     * Mutex to prevent race between returning query results and noticing that
     * we're timed-out or cancelled.
     */
    ...
    /**
     * Get the batched args as added by the addBatch method(s). The list is
     * unmodifiable and might contain any combination of String, BatchParams, or
     * BatchedBindValues depending on how the parameters were batched.
     *
    ...
    protected void checkForDml(String sql, char firstStatementChar)
        ...
        if ((firstStatementChar == 'I') || (firstStatementChar == 'U')
            ...
            if (StringUtils.startsWithIgnoreCaseAndWs(noCommentSql, "INSERT") //$NON-NLS-1$
                    ...
                    || StringUtils.startsWithIgnoreCaseAndWs(noCommentSql, "RENAME")) { //$NON-NLS-1$
                throw SQLError.createSQLException(Messages
     ...
     *
     * @exception SQLException if a database-access error occurs or direction is
     * not one of ResultSet.FETCH_FORWARD, ResultSet.FETCH_REVERSE, or
