...
public class StatementRegressionTest extends BaseTestCase {
     ...
     *
     * @throws Exception if the quoteid parsing fix in PreparedStatement doesn't
     * work.
     */
     ...
     * date class, as Calendar-constructed dates don't pass the .equals() test
     * :(
     */
    ...
    /**
     * Tests fix for Bug#58728, NPE in
     ...
     * prepared statement parameters (and duplicate BUG#60584 - prepared
     * statements truncate milliseconds)
     *
     * [13 Sep 2012 21:06] Mark Matthews This was fixed with
     * http://bazaar.launchpad.net/~mysql/connectorj/5.1/revision/1107 in 2011,
     ...
     * queries being executed. "RENAME" is also filtered now.
     *
     * @throws Exception
     */
